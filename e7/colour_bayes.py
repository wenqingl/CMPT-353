...
def main(infile):
    ...
    y_predicted = model_rgb.predict(Xvalid)

    # TODO: print model_rgb's accuracy score
    print("model_rgb's accuracy score:", model_rgb.score(Xvalid, yvalid))
    ...
    y_predicted_lab = model_lab.predict(Xvalid)

    # TODO: print model_lab's accuracy score
    print("model_lab's accuracy score:", model_lab.score(Xvalid, yvalid))
